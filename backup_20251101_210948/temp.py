...
# Temperature label
temp_label = label.Label(terminalio.FONT, text="Temp: --°C", color=0xFFFFFF, x=5, y=5)
screen.append(temp_label)

# Humidity label
humidity_label = label.Label(terminalio.FONT, text="Humidity: --%", color=0xFFFFFF, x=5, y=25)
screen.append(humidity_label)

# Uptime label
uptime_label = label.Label(terminalio.FONT, text="Uptime: -- min", color=0xFFFFFF, x=5, y=45)
screen.append(uptime_label)

# Trend label
trend_label = label.Label(terminalio.FONT, text="Trend: --", color=0xFFFFFF, x=5, y=65)
